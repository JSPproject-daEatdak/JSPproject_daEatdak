						...
						<div class="goods-section">
							...
							<div class="goods-contents">
								<div class="panel" id="panel1">
									<ul>
										<li><a
											href="http://127.0.0.1:5501/common/html/index.html#">
										...
										<li><a
											href="http://127.0.0.1:5501/common/html/index.html#">
												<div class="goods-zoom-container">
													<img
														src="${pageContext.request.contextPath}/resources/common/img/닭고기/닭가슴살 볼 깻잎맛.jpg"
														alt="닭메뉴2" />
												</div>
												<h5>다잇닭</h5>
										...
										<li><a
											href="http://127.0.0.1:5501/common/html/index.html#">
												<div class="goods-zoom-container">
													<img
														src="${pageContext.request.contextPath}/resources/common/img/닭고기/닭가슴살 볼 치즈맛.jpg"
														alt="닭메뉴3" />
												</div>
												<h5>다잇닭</h5>
										...
										<li><a
											href="http://127.0.0.1:5501/common/html/index.html#">
												<div class="goods-zoom-container">
													<img
														src="${pageContext.request.contextPath}/resources/common/img/닭고기/닭가슴살 크림머스타드.jpg"
														alt="닭메뉴4" />
												</div>
												<h5>다잇닭</h5>
										...
										<li><a
											href="http://127.0.0.1:5501/common/html/index.html#">
												<div class="goods-zoom-container">
													<img
														src="${pageContext.request.contextPath}/resources/common/img/닭고기/닭가슴살 짬뽕.jpg"
														alt="닭메뉴5" />
												</div>
												<h5>다잇닭</h5>
										...
										<li><a
											href="http://127.0.0.1:5501/common/html/index.html#">
												<div class="goods-zoom-container">
													<img
														src="${pageContext.request.contextPath}/resources/common/img/닭고기/닭가슴살 오븐구이 퀸즈.jpg"
														alt="닭메뉴6" />
												</div>
												<h5>다잇닭</h5>
										...
										<li><a
											href="http://127.0.0.1:5501/common/html/index.html#">
												<div class="goods-zoom-container">
													<img
														src="${pageContext.request.contextPath}/resources/common/img/닭고기/닭가슴살 오븐구이 칠리.jpg"
														alt="닭메뉴7" />
												</div>
												<h5>다잇닭</h5>
										...
										<li><a
											href="http://127.0.0.1:5501/common/html/index.html#">
												<div class="goods-zoom-container">
													<img
														src="${pageContext.request.contextPath}/resources/common/img/닭고기/닭가슴살 한끼볼 혼합.jpg"
														alt="닭메뉴8" />
												</div>
												<h5>다잇닭</h5>
										...
										<li><a
											href="http://127.0.0.1:5501/common/html/index.html#">
												<div class="goods-zoom-container">
													<img
														src="${pageContext.request.contextPath}/resources/common/img/닭고기/닭가슴살 블랙소이.jpg"
														alt="닭메뉴9" />
												</div>
												<h5>다잇닭</h5>
												<h6>소스통 닭가슴살 블랙소이</h6>
										...
										<li><a
											href="http://127.0.0.1:5501/common/html/index.html#">
												<div class="goods-zoom-container">
													<img
														src="${pageContext.request.contextPath}/resources/common/img/닭고기/닭가슴살 큐브 고추맛.jpg"
														alt="닭메뉴10" />
												</div>
												<h5>다잇닭</h5>
													...
													<c:if test="${loop.index < 10}">
														<li><a href="#">
																<div class="zoom-container">
																	<figure class="img">
																		<a
																			href="${pageContext.request.contextPath}/goods/goodsBuy.go?goodsNum=${goods.getGoodsNum()}">
																...
																<div class="zoom-container">
																	<figure class="img">
																		<a
																			href="${pageContext.request.contextPath}/goods/goodsBuy.go?goodsNum=${goods.getGoodsNum()}">
																			<img
																			src="${pageContext.request.contextPath}/resources/goods/img/chicken01.png"
																			alt="신상품2" />
																		</a>
																	</figure>
																</div>
												...
												<c:if test="${loop.index < 10}">
													<li><a
														href="${pageContext.request.contextPath}/goods/goodsBuy.go?goodsNum=${goods.getGoodsNum()}">
															<div class="zoom-container">
																<img
																	src="${pageContext.request.contextPath}/resources/goods/img/beverage01.png"
																	alt="신상품1" />
															</div>
															<p>
																<span>다잇닭</span>${goods.getGoodsName()}</p>
															<p>${goods.goodsPrice}원</p>
													</a></li>
												</c:if>
											</c:forEach>
