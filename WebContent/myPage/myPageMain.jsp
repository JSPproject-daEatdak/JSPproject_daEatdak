...
<script
	src="${pageContext.request.contextPath}/resources/myPage/js/myPageMain.js">
	// function pwCheck() {
		...
		<main>
			<div class="myPage-container">
				...
				<div class="sidemenu">
					...
					<div class="side-item">
						<a
							href="${pageContext.request.contextPath}/goods/goodsPurchaseList.go">
							...
							<div class="password-check-box">
								<div class="password-check-box-inner">
									...
									<b>비밀번호를 입력하세요.</b> <input class="content-password"
										type="password" id="inputPassword" maxlength="12"> <label
										id="notpw" style="display: none;">패스워드가 틀렸습니다.</label>
									<div class="inner-btnBox">
										<button class="btn cancle" onclick="history.go(-1)">취소</button>
										<%-- onclick="location.href='${pageContext.request.contextPath}/myPage/myPageUserConfig.jsp'" --%>
